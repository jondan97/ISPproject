...
public class AdminController {
    ...
    public String editAdvert (RedirectAttributes redir,
                              ...
                              @RequestParam String userCompanyName) throws IOException, MessagingException {
        ...
        if (!userExists && !(email.isEmpty() || password.isEmpty() || userCompanyName.isEmpty() || passwordConfirmation.isEmpty() || !password.equals(passwordConfirmation))){
                ...
                String emailSentTo = email;
                String emailSubject = "Account Created - ATH/TECH";
                String emailBody = "Your account for our website has been created. <br>" +
                    "You can now <a href='http://localhost:8080/login'> login </a> with the following credentials:" +
                    "<h1> E-mail: " + email + "</h1>" +
                    "<h1> Password: " + password + "</h1><br>" +
                    "You can change the password by clicking <a href='localhost:8080/user/passwordChange'> here </a>.";
