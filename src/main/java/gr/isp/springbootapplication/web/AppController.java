...
public class AppController {
    ...
    public String passwordChange(Model model) {
        SessionUserService.determineUser(model);
        System.out.println(SessionUserService.getSessionUser().getUsername() + "1");
        User u = userRepository.findFirstByEmail(SessionUserService.getSessionUser().getUsername());
        System.out.println(SessionUserService.getSessionUser().getPassword() + "2");
        System.out.println(u.getPassword() + "3");
        BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder(4);

        System.out.println(bCryptPasswordEncoder.matches("123", u.getPassword()));
